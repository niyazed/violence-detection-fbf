...
X_train = np.load('C:/Users/NBH/Desktop/violence-detection/movies_32x32_10FPS/train/'+labels[0] + '.npy')
y_train = np.zeros(X_train.shape[0])

for i, label in enumerate(labels[1:]):
    x = np.load('C:/Users/NBH/Desktop/violence-detection/movies_32x32_10FPS/train/'+label + '.npy')
...
X_test = np.load('C:/Users/NBH/Desktop/violence-detection/movies_32x32_10FPS/test/'+labels[0] + '.npy')
y_test = np.zeros(X_test.shape[0])

for i, label in enumerate(labels[1:]):
    x = np.load('C:/Users/NBH/Desktop/violence-detection/movies_32x32_10FPS/test/'+label + '.npy')
...
model.fit(X_train,y_train_cat, epochs=20, verbose=1, validation_data=(X_test,y_test_cat), batch_size=32, callbacks=[TensorBoard(log_dir='/tmp/cnn')])
