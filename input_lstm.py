...
X_train = np.load('C:/Users/NBH/Desktop/violence-detection/hockey_32x32_10FPS/train/'+labels[0] + '.npy')
y_train = np.zeros(X_train.shape[0])

for i, label in enumerate(labels[1:]):
    x = np.load('C:/Users/NBH/Desktop/violence-detection/hockey_32x32_10FPS/train/'+label + '.npy')
...
X_test = np.load('C:/Users/NBH/Desktop/violence-detection/hockey_32x32_10FPS/test/'+labels[0] + '.npy')
y_test = np.zeros(X_test.shape[0])

for i, label in enumerate(labels[1:]):
    x = np.load('C:/Users/NBH/Desktop/violence-detection/hockey_32x32_10FPS/test/'+label + '.npy')
...
layer = CuDNNLSTM(200,return_sequences=False, kernel_regularizer=regularizers.l2(0.01)) (layer)
